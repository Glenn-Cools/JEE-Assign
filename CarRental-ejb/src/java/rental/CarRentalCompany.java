...
public class CarRentalCompany {
    ...
    // CarTypes are added through the company owned cars
    ...
    public CarRentalCompany(String name,Set<String> regions, List<Car> cars) {
    ...
    private void setRegions(Set<String> regions) {
